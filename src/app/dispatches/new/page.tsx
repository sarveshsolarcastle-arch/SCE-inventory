...
export default async function NewDispatchPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Stock_Out"
        subtitle="Material leaving the store for a site, recorded as one challan. Nothing is written until every row is matched to an item, covered by available stock, and any sealed pack that must be opened is approved."
      />
